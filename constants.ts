...
export const FITNESS_CURRICULUM: Course = {
  ...
  lessons: [
    { 
      ...
      type: 'video', 
      content: 'https://github.com/v9741812-coder/course-media/releases/download/v1/Module.1_1.mp4', 
      duration: '', 
      isCompleted: false, 
    ...
    { 
      ...
      type: 'video', 
      content: 'https://github.com/v9741812-coder/course-media/releases/download/v1/Module.10_1.mp4', 
      duration: '', 
      isCompleted: false, 
